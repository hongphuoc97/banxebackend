...
<div class="container-fluid" >
    ...
    <div class="col-md-9 clearfix">
     ...
     <p>
        Là nhà nhập khẩu chuyên nghiệp các sản phẩm máy xúc lật SDLG, máy xúc lật nhỏ, máy xúc lật chui hầm, máy nâng đá, máy xúc đào…
        Xuất phát từ một doanh nghiệp trẻ năng động nhưng chúng tôi đủ niềm tin đã xây dựng được hệ thống cơ sở vật chất tốt nhất dành cho khách hàng,
        chúng tôi có kho bãi khang trang và showroom hiện đại. Bên cạnh đó, chúng tôi tự hào có đội ngũ kinh doanh giỏi, quản lý xuất sắc, đội ngũ kỹ thuật và dịch vụ chuyên nghiệp,
     ...
     <p style="text-align: center;"><span style="font-family: helvetica, arial, sans-serif; font-size: 12pt;"><em>&nbsp; Máy xúc lật SDLG</em></span></p>
     ...
     <p style="text-align: center;"><span style="font-family: helvetica, arial, sans-serif; font-size: 12pt;"><em>Xe nâng Lonking</em></span></p>
     ...
     <p style="text-align: center;"><span style="font-family: helvetica, arial, sans-serif; font-size: 12pt;"><em>Kho phụ tùng</em></span></p>
     <p style="text-align: justify;"><strong><span style="font-family: helvetica, arial, sans-serif; font-size: 12pt;">Mọi ý kiến đóng góp hãy gửi về:</span></strong></p>
     <p style="text-align: justify;"><strong><span style="font-family: helvetica, arial, sans-serif; font-size: 12pt;">Mr Hoàng – Công Ty TNHH Hoằng Giai&nbsp;</span></strong></p>
     <p style="text-align: justify;"><strong><span style="font-family: helvetica, arial, sans-serif; font-size: 12pt;">Hotline : 096.5707.022</span></strong></p>
     <p style="text-align: justify;"><strong><span style="font-family: helvetica, arial, sans-serif; font-size: 12pt;">Email : haihoang.car@gmail.com</span></strong></p>
  </div>
 </div>
@endsection
